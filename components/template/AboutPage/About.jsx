    ...
    <div className="AboutPage">
      <div className="content_about flex">
        ...
        <div className="img_about">
          <Image src="/Img/img_About.png" width={600} height={700} className="max-[992px]:w-[350px]"/>
        </div>
        {/* caption about */}
        <div className="caption_about w-[466px] flex flex-col m-auto max-[992px]:max-w-[360px]">
